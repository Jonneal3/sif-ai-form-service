...
from programs.batch_generator.engine.utils import _normalize_step_id
...
def _reject_banned_option_sets(step: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    We intentionally do NOT rewrite/patch model outputs here.
    If outputs are bad, fix the DSPy program (demos + prompt), not post-processing.
    """

...
def build_image_prompt(payload: Dict[str, Any], *, prompt_template: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        from sif_ai_form_service.pipeline.form_pipeline import _build_context as _build_context  # type: ignore
        from sif_ai_form_service.pipeline.form_pipeline import _compact_json as _compact_json  # type: ignore
        from sif_ai_form_service.pipeline.form_pipeline import _configure_dspy as _configure_dspy  # type: ignore
        from sif_ai_form_service.pipeline.form_pipeline import _make_dspy_lm as _make_dspy_lm  # type: ignore
    except Exception:
        return {
            "ok": False,
    ...
    try:
        ...
        from sif_ai_form_service.schemas.image_prompt import ImagePromptSpec
    except Exception as e:
        return {
            "ok": False,
